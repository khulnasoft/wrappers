...
`Wrappers` is also a collection of FDWs built by [Khulnasoft](https://www.khulnasoft.com). We currently support the following FDWs, with more under development:
...
- [Usage Docs](https://khulnasoft.github.io/wrappers/)
- [Developer Docs (docs.rs)](https://docs.rs/khulnasoft-wrappers/latest/khulnasoft_wrappers/)
...
To develop a FDW using `Wrappers`, you only need to implement the [ForeignDataWrapper](./khulnasoft-wrappers/src/interface.rs) trait.
