...
//! - JsonB
//!
//! See the full supported types list in [`interface::Cell`]. More types will be added in the future if needed or you can [raise a request](https://github.com/khulnasoft/wrappers/issues) to us.
//!
//! # Developing a FDW
//!
...
//! use khulnasoft_wrappers::prelude::*;
//! #[wrappers_fdw(
//!    version = "0.1.1",
//!    author = "Khulnasoft",
//!    website = "https://github.com/khulnasoft/wrappers/tree/main/wrappers/src/fdw/helloworld_fdw",
...
//! - [Auth0](https://github.com/khulnasoft/wrappers/tree/main/wrappers/src/fdw/auth0_fdw): A FDW for [Auth0](https://auth0.com/) which supports data read only.
...
pub use khulnasoft_wrappers_macros::wrappers_fdw;
