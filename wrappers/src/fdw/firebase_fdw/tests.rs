        ...
        Spi::connect(|mut c| {
            ...
            */
            ...
            assert_eq!(
                results,
                vec![
                ("projects/kengine/databases/(default)/documents/my-collection/bSMScXpZHMJe9ilE9Yqs",
                 serde_json::json!({
                     "id": { "integerValue": "1" },
            ...
            assert_eq!(
                results,
                vec![
                ("projects/kengine/databases/(default)/documents/my-collection/bSMScXpZHMJe9ilE9Yqs/my-collection2/fkSWL4hNJ3lRc1ZIorPm",
